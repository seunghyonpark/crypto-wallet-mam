  ...
  */
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-left justify-center gap-3 p-5 text-gray-100">
        ...
        <div className="p-2 grid grid-cols-1 lg:grid-cols-1 w-full lg:w-2/3 gap-5 ">
          ...
          <div className="w-full  rounded-lg flex flex-col items-left justify-left gap-5 py-0 ">
            ...
            <div className=" text-sm text-gray-200 h-[400px]">

            1. The agreement is concluded between You<br></br><br></br>
            2. In order for you to better understand the risks associated in digital-asset trading,<br></br><br></br>
            3. This Agreement includes the General, Know-Your-Customer, Anti-Money Laundering Policy, Privacy Policy
